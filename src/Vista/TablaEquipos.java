 ...
 * @author Alumno
 */
public class TablaEquipos extends JFrame {
    ...
    public TablaEquipos() {
        db.abrirConexion();
        rs = AccesoBase.consultaTablaEquipos();
    ...
    class MyTableModel extends AbstractTableModel {
        ...
        final String[] columNames = {"Id", "Nombre", "Telefono", "Presidente", "Director de Marketing", "Precio entrada"};
        String[][] data = null;
